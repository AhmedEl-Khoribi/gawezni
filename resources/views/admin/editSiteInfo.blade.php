...
<div class="box box-danger">
  ...
  <div class="row">
      <div class="col-xs-4">  
        <h5>Old Site Logo</h5>
      <img src="/public/site_info/{{ $info->logo }}" width="215">
      </div>
      <div class="col-xs-8">  
  ...
  <div class="row">
      ...
      <img src="/public/site_info/{{ $info->fivicon }}" width="215">
      </div>
      <div class="col-xs-8">  
  ...
  <div class="row">
      ...
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">Website Uses
          </h3>
        ...
        <div class="box-body pad">
                <textarea id="editor1" name="website_used" rows="10" cols="80">
                     {{ $info->website_used }}
                </textarea>
        </div>
      </div>
