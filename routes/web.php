...
Route::get('/profile_views/{id}', 'ProfileViewController@addView');
...
Route::group(['prefix' => 'admin', 'middleware'=>'admin'], function () {
  ...
  Route::get('/all_users', 'dashboard\ClientsController@forExcel');
...
Route::group(['prefix' => 'client'], function () {
  ...
  //messages
  Route::get('/message', 'UserController@showCoversations');
  Route::get('/message/{id}', 'UserController@viewMessages');
  Route::post('/message', 'UserController@sendMessage');
  ...
  //visits
  Route::get('/visits','ProfileViewController@visits');
  
  //Advanced Search
  Route::get('/advanced_search', 'FastSearchController@advanced_search');
  Route::get('/AS', 'FastSearchController@advanced_search_results');
