...
<div class="row">
    ...
    <h1>هتجوز</h1> 
        ...
        <p>
            <h2 for="username" class="icon-user"> 
                        مرحبا  في موقع هتجوز {{ $user->lname }}{{ $user->fname }}
        ...
        <p style="text-align: center">
         تم تسجيلك في الموقع بنجاح انتظر حتي يتم تفعيلك من قبل الادارة</p> 
        <p style="margin-top: 80px ;position: absolute; bottom: 0">
	<img src="www.hatgwez.com/visitor/images/logo-man.png"  style=" direction: rtl ">
</p>
</div>
	</div>
