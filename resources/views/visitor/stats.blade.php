...
<br>
    ...
    <div class="container">
    <h1 style="color: #27aae1">الزائرون</h1>
<div class="row">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">الزائرون</span>
          <span class="info-box-number">{{ $number_of_visits }}</span>
        </div>
      </div>
    </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <table class="table table-striped" id="myTable" data-freezecolumns="2" style="direction: rtl">
                    <thead style="color: #27aae1">
                        <tr>
                            <th rowspan="1">الصوره</th>
                            <th colspan="2">الاسم</th>
                            <th colspan="2">تاريخ الزيارة</th>
                            <th colspan="2">الدولة</th>
                            <th colspan="2">المدينة</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            @php
                                $viewer_name = App\Client::where('id', $viewer->client_id)->first();
                            @endphp
                            <td rowspan="1"><img src="/files/users/{{ $viewer_name->image }}" width="50px"></td>
                            <td colspan="2"><a href="/client/profile/{{ $viewer_name->id }}">{{ $viewer_name->username }}</a></td>
                            <td colspan="2" style="direction:ltr">{{ $viewer->created_at->diffForHumans() }}</td>
                            <td colspan="2">{{ $viewer_name->city->country->name }}</td>
                            <td colspan="2">{{ $viewer_name->city->name }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
