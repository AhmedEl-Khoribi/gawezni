...
@include('visitor.template.nav')
	...
	<br>
	<br>
	<h1 style="text-align: center">  تحذير   
   </h1>
		<div class="row">
		...
		<br>
				<br>
				<br>
					<div style="border: 1px solid black ;  border-radius:20px;padding: 50px" class="alert alert-warning">
  <h2 style="text-align: center">
  	<i class="fa fa-warning" style="color: #E7AF0B; font-size: 50px"></i>  
  	لا يمكنك رؤيه محتوى هذه الصفحة 
  </h2> 
 </div>
