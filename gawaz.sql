...
--
-- Host: 127.0.0.1
-- Generation Time: 25 يونيو 2018 الساعة 23:36
...
--
-- بنية الجدول `admin_password_resets`
--
...
--
-- بنية الجدول `admin_to_client_messages`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `admin_to_client_messages`
--
...
(1, 2, 2, '2018-06-25 18:40:29', '2018-06-25 18:40:29');
...
--
-- إرجاع أو استيراد بيانات الجدول `mails`
--

INSERT INTO `mails` (`id`, `sender_id`, `receiver_id`, `read`, `body`, `created_at`, `updated_at`) VALUES
(1, 6, 27, 'unseen', 'dfgdfgfd', '2018-06-05 22:00:00', '2018-05-31 22:00:00'),
(2, 6, 15, 'unseen', 'sdfsdkjfhhsjdfdsf', '2018-06-03 22:00:00', '2018-06-18 22:00:00'),
(3, 17, 23, 'unseen', 'sadsadsad', '2018-06-19 22:00:00', '2018-06-12 22:00:00');
...
--
-- إرجاع أو استيراد بيانات الجدول `profile_views`
--

INSERT INTO `profile_views` (`id`, `client_id`, `profile_id`, `created_at`, `updated_at`) VALUES
(6, 2, 10, '2018-06-25 19:06:38', '2018-06-25 19:06:38'),
(7, 2, 2, '2018-06-25 19:09:25', '2018-06-25 19:09:25');

-- --------------------------------------------------------

--
-- بنية الجدول `site_infos`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `site_infos`
--
