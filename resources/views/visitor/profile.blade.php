...
<body id="profile">
  ...
  <input type="hidden" name="client_id" value="{{ $user->id }}" id="client_id">
    @endif
	<!--start-home-->
...
<div class="contaier">
 ...
 <div class="row">
  ...
  <!-- Dislike Button -->
  <div class="ban">
    <a href="/client/message/{{ $user->id }}" title="أرسل رسالة">
      <i class="fa fa-envelope"  style="color:#169AF9"></i>
      <i class="outer fa fa-circle-thin"  style="color:#169AF9"></i>
    </a>
  </div>
  ...
  @if(Auth::guard('client')->check())
      ...
      @endphp
      @if($is_liked === false)
      <div class="like friend_request"  title="اعجاب">
        <span id="pending{{ $user->id }}">
        <i class="fa fa-heart"></i>
        <i class="outer fa fa-circle-thin"></i>
        </span>
      </div>
      <input type="hidden" name="friend_id" value="{{ $user->id }}" class="friend_id">
       @else
      <div class="like friend_request" disabled>
        <span id="pending{{ $user->id }}">
  ...
  <!-- Creds -->
  <div class="ban">
  <a href="/client/block/{{ $user->id }}"  title="حظر ">
    <i class="fa fa-ban"></i>
    <i class="outer fa fa-circle-thin"></i>
  </a>
  </div>
