                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            @foreach($country->cities as $city)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('admin/city/'. $city->id . '/edit') }}"  class="btn btn-success"><i class="fa fa-edit"> Edit</i></a>
                                                        <form action="{{url('admin/city/'. $cityx   ->id) }}" method="post" style="display: inline;">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="country_id">
                                    ...
                                    @foreach($cntry as $country)
                                        <option value="{{ $country->id }}" @if($countryCity->country->id == $country->id) {{ 'selected' }} @endif>{{ $country->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
