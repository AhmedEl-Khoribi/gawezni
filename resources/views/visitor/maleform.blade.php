...
<body style="background-color: #333 ; background-size: cover; font-family: 'Aref Ruqaa', serif;"  >
<!--start-home-->
@if ($errors->any())
            ...
            <fieldset>
                ...
                <div class="step1">
                    ...
                    <div class="row cf">
                        ...
                        <input type="text"  value="{{ old('dob') }}" id="dob" name="dob" required >
                    </div>
                ...
                <div class="step3">
                    ...
                    <div class="row cf">
                        <label>     الوزن     </label>
                        <input type="text" value="{{ old('weight') }}" id="weight"  name="weight" required style="direction: rtl ;float: right" placeholder=" الوزن">
                    </div>
                    <span id="weightText" class="text-center"></span>
                    <div class="row cf">
                        <label>     الطول     </label>
                        <input type="text" value="{{ old('height') }}"  name="height" id="height" required style="direction: rtl ;float: right" placeholder="الطول ">
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        {
            var text ='<span style="color: #db0141;margin-left:30px">' + message + '</span>';
            $(place).html(text);
