	...
	<h1 style="text-align: center"> راسل إدارة الموقع  </h1>
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<h5>   
يرجى مراجعة <a href="/client/faq">الأسئلة المتداولة</a> أولا قد تجد جوابا لسؤالك. <br><br>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  ...
  <form id="contact" action="/client/toAdmin" method="post">
    ...
    <div class="form-group">
        <input style="direction:rtl" class="form-control" placeholder="من: {{ \Auth::guard('client')->user()->username }}" disabled>
    </div>
    <div class="form-group">
        <input style="direction:rtl" class="form-control" placeholder="البريد الاكتروني: {{ \Auth::guard('client')->user()->email }}" disabled>
    </div>
    <fieldset>
