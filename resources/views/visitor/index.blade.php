...
<div class="cont">
  ...
  <div class="form">
    <form action="{{ url('/client/home') }}" method="post">
      <h1>تسجيل الدخول</h1>
      	{{ csrf_field() }}
		<input type="text" name="username" class="user" style=" font-size: 14px;" placeholder="اسم المستخدم او البريد الالكتروني او رقم التليفون"/>
		...
		<div class="form-group" style="float:right">
			<label for="remember">تذكرني لاحقا <input type="checkbox" name="remember" id="remember" value="1">  </label>
		</div>
	...
	<div class="container gallery-section">
		<div class="row">
			...
			@foreach($top_6_users as $user)
				<div class="col-lg-2 col-md-2 col-xs-4 col-sm-4" style="margin:5px">
					<a href="/client/profile/{{ $user->id }}">
						<img src="{{ asset('files/users/' . $user->image ) }}" style="width: 100%;height: 110px;border-radius: 50%" >
					</a>
				</div>
			@endforeach
	...
	<div class="container" style="direction: rtl">
		<div class="row">
			<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 chat">
				...
				<hr>
				<h4>متواجد حاليا  ({{ \App\Client::where('online' ,'online')->count() }})
				<hr>
				<div class="col-sm-6 col-xs-6">
				<a href="https://hatgwez.rocket.chat" target="_blank">
				...
				<div class="col-sm-12 col-xs-12 chat2 hidden-xs hidden-sm">
